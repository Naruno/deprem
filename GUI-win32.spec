...
a = Analysis(['deprem_decentra_network\\gui\\main.py','deprem_decentra_network\\gui_lib\\libs\\baseclass\\alert_screen.py', 'deprem_decentra_network\\decentra_network_integration.py'],
             pathex=[],
             binaries=[],
             datas=[
